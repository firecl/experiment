...
.node-start {
  background: url('./assets/background/start.png') no-repeat;
  background-size: cover;
}
.node-rect {
...
.node-user {
  background: url('./assets/background/user.png') no-repeat;
  background-size: cover;
}
.node-time {
  background: url('./assets/background/time.png') no-repeat;
  background-size: cover;
}
.node-push {
  background: url('./assets/background/push.png') no-repeat;
  background-size: cover;
}
.node-download {
  background: url('./assets/background/download.png') no-repeat;
  background-size: cover;
}
.node-click {
  background: url('./assets/background/click.png') no-repeat;
  background-size: cover;
}
.node-end {
  background: url('./assets/background/end.png') no-repeat;
  background-size: cover;
}
.bpmn-start {
